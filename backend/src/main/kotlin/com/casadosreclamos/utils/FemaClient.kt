...
class FemaClient {
        ...
        fun getServices(source: Address, destination: Address): Uni<List<Service>> {
                ...
                return expeditionsClient.getServices(body).onItem().transform { response ->
                        ...
                        val state =
                                getXMLElement(soapBody, "ServicosResponse/ServicosResult/State")
                                        ?.textContent
                        val message =
                                getXMLElement(soapBody, "ServicosResponse/ServicosResult/Message")
                                        ?.textContent
                        val services =
                                getXMLElement(soapBody, "ServicosResponse/ServicosResult/Servicos")
                                        ?.childNodes
        ...
        fun openWaybill(waybill: WaybillDto): Uni<Label> {
                ...
                return expeditionsClient
                        .openWaybill(body.replace("&", "&amp;"))
                        .onItem()
                        .transform { response ->
                                val doc: SOAPMessage =
                                        xmlBuilder.createMessage(
                                                null,
                                ...
                                val state =
                                        getXMLElement(soapBody, "CriarResponse/CriarResult/State")
                                                ?.textContent
                                val message =
                                        getXMLElement(soapBody, "CriarResponse/CriarResult/Message")
                                                ?.textContent
                                val id =
                                ...
                                val pdf =
                                        getXMLElement(
                                                        soapBody,
                                                        "CriarResponse/CriarResult/Etiqueta/base64Label"
                                                )
                                                ?.textContent
        ...
        fun cancelWaybill(waybillId: Long): Uni<Void> {
                ...
                return expeditionsClient.cancelWaybill(body).onItem().transformToUni { response ->
                        ...
                        val state =
                                getXMLElement(soapBody, "AnularResponse/AnularResult/State")
                                        ?.textContent
                        val message =
                                getXMLElement(soapBody, "AnularResponse/AnularResult/Message")
                                        ?.textContent
        ...
        fun getWaybill(waybillId: Long, labelFormat: String): Uni<File> {
                ...
                return expeditionsClient.getWaybill(body).onItem().transform { response ->
                        ...
                        val state =
                                getXMLElement(soapBody, "EtiquetaResponse/EtiquetaResult/State")
                                        ?.textContent
                        val message =
                                getXMLElement(soapBody, "EtiquetaResponse/EtiquetaResult/Message")
                                        ?.textContent
                        val pdf =
                                getXMLElement(
                                                soapBody,
                                                "EtiquetaResponse/EtiquetaResult/Etiqueta/base64Label"
                                        )
                                        ?.textContent
        ...
        fun closeDay(): Uni<File> {
                ...
                return expeditionsClient.closeDay(body).onItem().transform { response ->
                        ...
                        val state =
                                getXMLElement(soapBody, "FecharDiaResponse/FecharDiaResult/State")
                                        ?.textContent
                        val message =
                        ...
                        val pdf =
                                getXMLElement(
                                                soapBody,
                                                "FecharDiaResponse/FecharDiaResult/Report/base64Label"
                                        )
                                        ?.textContent
