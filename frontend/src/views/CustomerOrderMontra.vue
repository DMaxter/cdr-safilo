            ...
            <v-row no-gutters justify="start" class="pt-2 pl-2">
              <v-menu :offset-x="true" tile>
                ...
                <v-btn-toggle v-model="icon" tile dark borderless>
                  <v-btn color="#808080" value="left" height="64" width="160" @click="$router.push('profile')"
        ...
        ></v-select>
                              ...
                              <v-col cols="7">
                                <v-select height="30" style="border-radius: 0px; width:280px" :items="finishes"
                                  label="Acabamentos" dense multiple hide-details outlined v-model="finish[`finish` + n]">
                                  <template v-slot:selection="{ item, index }">
                                    <span v-if="index === 0">{{ item }}</span>
                                    <span v-if="index === 1" class="ml-2 mt-1 grey--text text-caption">
                              ...
                              <v-dialog v-model="dialog" persistent max-width="800" scrollable>
                                <v-card>
                                        ...
                                        <v-row>
                                          <v-col v-for="(image, i) in images" :key="i" cols="3">
                                            <v-item v-slot="{ active, toggle }">
                                              <v-img :src=image.link height="150" @click="toggle">
                                                <div v-if="active" class="selectedOne">
                                                </div>
                                              </v-img>
                                            </v-item>
                                          </v-col>
                                  ...
                                  <v-card-actions>
                                    ...
                                    <v-btn color="green darken-1" text @click="dialog = false; picked = []">
                                      Voltar
                                    </v-btn>
        ...
        ></v-select>
                              ...
                              <v-col cols="3">
                                <v-select style="border-radius: 0px;" :items="finishes" label="Acabamentos" dense multiple
                                  hide-details outlined v-model="finish[`finish` + n]"></v-select>
                              </v-col>
                              <v-col cols="2">
                                <v-text-field style="border-radius: 0px;" label="Largura" dense outlined hide-details
                                  v-model="widths[`width` + n]"></v-text-field>
                              </v-col>
                              <v-col cols="2">
                                <v-text-field style="border-radius: 0px;" label="Altura" outlined dense hide-details
                                  v-model="heights[`height` + n]"></v-text-field>
                              </v-col>
                            </v-row>
                            <v-row justify="center" align="center" class="d-flex">
                              <v-dialog v-model="dialog" persistent max-width="800" scrollable>
                              ...
                              <v-col cols=3>
                                <v-img :src="myImage" contain height="50px" width="50px"
