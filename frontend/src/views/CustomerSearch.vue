        ...
        <v-col cols="auto" >
          ...
          <v-row no-gutters justify="start" class="pt-2 pl-2">
            ...
            <v-btn-toggle v-model="icon" tile dark borderless>
              ...
              <v-btn color="#808080" value="center2" @click="$router.push('search')" height="64" width="130" class="v-btn--active customGradient">
...
export default {
  ...
  methods: { 
    searchFilters() {
      store.codeSearch = null
      store.materialSearch = null
      store.estadoSearch = null
      if (this.text != "") {
